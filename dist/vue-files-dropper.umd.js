(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-files-dropper"] = factory(require("vue"));
	else
		root["vue-files-dropper"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"/home/vpugachev/projects/vue-files-dropper/node_modules/.cache/vue-loader","cacheIdentifier":"02bea4b2-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueFilesDropper.vue?vue&type=template&id=633d4ac8&scoped=true
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes,on:{"click":_vm.onClick,"mouseover":function($event){_vm.hover = true},"mouseleave":function($event){_vm.hover = false},"drop":function($event){$event.preventDefault();return _vm.onDrop($event)},"dragover":function($event){$event.preventDefault();_vm.hover = true},"dragleave":function($event){$event.preventDefault();_vm.hover = false}}},[(_vm.canClear)?_c('button',{staticClass:"v-files-dropper__clear",attrs:{"type":"button"},on:{"click":function($event){$event.stopPropagation();return _vm.onClear($event)}}},[_vm._v("×")]):_vm._e(),_vm._t("default"),_c('input',{ref:"input",attrs:{"type":"file","disabled":_vm.disabled,"multiple":_vm.multiple,"accept":_vm.accept},on:{"change":_vm.onChange}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/VueFilesDropper.vue?vue&type=template&id=633d4ac8&scoped=true
...
/* harmony default export */ var VueFilesDroppervue_type_script_lang_js = ({
  ...
  computed: {
    ...
    acceptMimes: function acceptMimes() {
      return this.accept.split(',').map(function (item) {
  ...
  methods: {
    ...
    emit: function emit(files) {
      if (!this.filesAccept(files)) return false;
      if (!this.multiple) return this.$emit('input', files[0]);
      if (!this.value) return this.$emit('input', files);
      return this.$emit('input', Array.from(files));
    },
    filesAccept: function filesAccept(files) {
      var _this = this;

      return files.every(function (file) {
        var type = file.type.split('/');
        return _this.acceptMimes.some(function (accepted) {
          if (accepted[0] === '*' || accepted[0] === type[0] && accepted[1] === '*' || accepted[0] === type[0] && accepted[1] === type[1]) {
            return true;
          }

          var error = new Error("File ".concat(file.name, " has not accepted type ").concat(file.type));
...
// EXTERNAL MODULE: ./src/components/VueFilesDropper.vue?vue&type=style&index=0&id=633d4ac8&lang=scss&scoped=true
var VueFilesDroppervue_type_style_index_0_id_633d4ac8_lang_scss_scoped_true = __webpack_require__("c8k7");
...
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.component('VueFilesDropper', VueFilesDropper);
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueFilesDropper_vue_vue_type_style_index_0_id_633d4ac8_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("oVNu");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueFilesDropper_vue_vue_type_style_index_0_id_633d4ac8_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueFilesDropper_vue_vue_type_style_index_0_id_633d4ac8_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueFilesDropper_vue_vue_type_style_index_0_id_633d4ac8_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default.a); 
